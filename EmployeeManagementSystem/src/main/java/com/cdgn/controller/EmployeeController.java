...
public class EmployeeController {
	...
	public ModelAndView saveEmployee(@ModelAttribute Employee employee) {
		...
		if(emp != null) {
			mav.addObject("status","Employee Regestered Successfully");
		}
		else {
			mav.addObject("status","Employee Regestration Failed....");
		}
		return mav;
	}
	...
	public ModelAndView login(@RequestParam String email,@RequestParam String password,HttpSession session) {
		...
		ModelAndView mav;
		if(email.equals("admin@codgnan.com") && password.equals("admin@123")) {
	...
	public ModelAndView updateEmployee(@ModelAttribute Employee employee) {
		...
		ModelAndView mav = new ModelAndView("findAll");
		mav.addObject("employee1",employee1);
		return mav;
	}
